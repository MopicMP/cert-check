...
[![PyPI version](https://badge.fury.io/py/cert-check.svg)](https://pypi.org/project/cert-check/)
...
```bash
pip install cert-check
```

## Quick Start

```python
from cert_check import check
